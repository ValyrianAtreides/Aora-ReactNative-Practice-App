...
const Create = () => {
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView classNanme="px-4 my-6 ">
        <Text className="text-2xl text-white font-psembold mt-10">
          Upload Video
        </Text>
        <FormField 
          title="Video Title"
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker('image')}>
            {form.thumbnail ? (
              ...
              <View className="w-full h-16 px-4 bg-black-100 rounded-3xl justify-center items-center border-2 border-black-200 flex-row space-x-2" >
